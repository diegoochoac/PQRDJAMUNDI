  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header" data-background-color="blue">
        <h4 class="title">Nuevo usuario credencial</h4>
      </div>
      <div class="card-content table-responsive">
        ...
        <form class="form-horizontal" method="post" id="addproduct" action="index.php?view=adduser" role="form">
          ...
          <div class="form-group">
            <label for="inputEmail1" class="col-lg-2 control-label">Activar</label>
            <div class="col-md-6">
              <div class="checkbox">
                <label>
          ...
          <div class="form-group">
            <div class="col-lg-offset-2 col-lg-10">
              <button type="submit" class="btn btn-primary">Agregar Usuario Credencial</button>
            </div>
          </div>
        </form>
      </div>
