...
<div class="row">
	...
	?>
		...
		<?php
						...
						echo "<p class='alert alert-danger'>No hay Afectados</p>";
					}
		?>

		<br>
		<hr>
		<h4 class="title">Lista de todos los Peticionarios</h4>
		<?php
					$users = PacientDataP::getAll();
					if (count($users) > 0) {
						// si hay usuarios
		?>
		...
		<?php
						...
						echo "<p class='alert alert-danger'>No hay Peticionrios</p>";
					}
		?>
